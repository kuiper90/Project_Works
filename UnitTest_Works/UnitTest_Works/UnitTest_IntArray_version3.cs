...
{
    public class UnitTest_IntArray_version3
    {
        public IntArray_version3 ArrayFactory()
        {
            IntArray_version3 intArr = new IntArray_version3();
        ...
        {
            IntArray_version3 arr = ArrayFactory();
